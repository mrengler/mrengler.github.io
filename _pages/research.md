...
I contributed to the [Integrity Institute response](https://www.integrityinstitute.org/research/request-for-information-about-securing-ai-agent-systems) to NIST's RFI on agentic security and authored a [report](https://gifct.org/wp-content/uploads/2023/09/GIFCT-23WG-0823-GenerativeAI-1.1.pdf) on generative AI and online extremism for the [Global Internet Forum to Counter Terrorism](https://gifct.org/). I also wrote a chapter on [AI and automation](https://www.tspa.org/curriculum/ts-fundamentals/automated-systems-and-ai/) for the [Trust and Safety Professional Association](https://www.tspa.org/) curriculum. Earlier writing includes [pieces](https://techpolicy.press/solarwinds-hack-signals-necessity-of-federal-breach-notification-law/) for [Tech Policy Press](https://techpolicy.press/new-eu-privacy-rule-may-complicate-moderation-of-child-sexual-abuse-material/), [New_ Public](https://newpublic.org/article/1954/how-zero-trust-security-locks-out-marginalized-internet-users), and the Integrity Institute [blog](https://integrityinstitute.org/our-ideas/hear-from-our-fellows/middleware-and-the-customization).
